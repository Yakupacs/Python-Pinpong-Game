...
yazi.penup()
yazi.goto(0, 270)
yazi.write("Player A = 0   Player B = 0", align='center', font=('Courier', 17, "bold"))
yazi.hideturtle()
puan_a = 0
puan_b = 0
...
while True:
    ...
    if ball.xcor() > 390:
        ...
        puan_a = puan_a + 1
        yazi.clear()
        yazi.write("Player A = {}  Player B = {}".format(puan_a, puan_b), align='center', font=('Courier', 17, "bold"))
